                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <select
                        ...
                        required
                        onChange={(e) =>
                          setNested("location", "province", e.target.value)
                        }
                      >
                        <option value="">Select Province</option>
                        {PROVINCES.map((p) => (
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        onChange={(e) =>
                          setNested("location", "district", e.target.value)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNested("location", "municipality", e.target.value)
                        }
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNested("location", "ward", e.target.value)
                        }
                      />
                    </div>
                    <div className="sm:col-span-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNested("location", "street", e.target.value)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNested("contactPerson", "name", e.target.value)
                        }
                      />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setNested("contactPerson", "phone", e.target.value)
                        }
                      />
                    </div>
                    <div>
